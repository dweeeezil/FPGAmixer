...
HD_PWD='C:/Users/Alex/Desktop/FPGAmixer_main/FPGAmixer/vivado_project/FPGAmixer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log phase3_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source phase3_top.tcl -notrace
