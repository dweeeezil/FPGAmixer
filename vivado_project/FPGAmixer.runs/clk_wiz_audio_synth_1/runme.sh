...
HD_PWD='C:/Users/Alex/Desktop/FPGAmixer_main/FPGAmixer/vivado_project/FPGAmixer.runs/clk_wiz_audio_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_audio.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_audio.tcl
