...
HD_PWD='C:/Users/Alex/Desktop/FPGAmixer_main/FPGAmixer/vivado_project/FPGAmixer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log phase3_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source phase3_top.tcl
